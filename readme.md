# Simple RTL-SDR Radar
A passive motion detection system using FM radio signals and a single RTL-SDR dongle. Detects human motion by analyzing phase and amplitude variations in reflected FM broadcasts.
## Overview
...
**Key Achievement:** Human motion detection with a single antenna setup - typically considered extremely difficult in passive radar applications.
## How It Works
### The Physics
